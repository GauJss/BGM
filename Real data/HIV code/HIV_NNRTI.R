...
drug_class = 'NNRTI' # Possible drug types are 'PI', 'NRTI', and 'NNRTI'. In the paper we restrict to PI and NRTI.
...
# Data summary
Name_Pro = c("DLV","EFV", "NVP")
data_size = cbind(c(730, 732, 744),
                  c(305, 312, 313))
...
for (drug in Name_Pro) {
  ...
  plot_data=rbind(plot_data[1,]+2
                  *plot_data[2,]/3,plot_data[2,]-2*plot_data[2,]/3)
